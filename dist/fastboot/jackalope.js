...
define("jackalope/templates/application", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["block", "md-navbar", [], ["name", "Jackalope Design", "class", "blue-grey darken-2", "homeRoute", "index"], 0, null, ["loc", [null, [2, 2], [13, 16]]]], ["content", "outlet", ["loc", [null, [17, 0], [17, 10]]]], ["content", "md-modal-container", ["loc", [null, [28, 0], [28, 22]]]]],
      locals: [],
      templates: [child0]
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el3, "src", "http://placekitten.com/300/300");
        ...
        dom.setAttribute(el4, "src", "http://placekitten.com/100/100");
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("div");
        dom.setAttribute(el4, "class", "exp-container");
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        ...
        var el7 = dom.createTextNode("Digital Roots");
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("h5");
        var el7 = dom.createTextNode("RIIS");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n          ");
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("p");
        var el7 = dom.createTextNode("\n            Created beautiful UIs for many clients including: Cengage Learning,\n            Blue Cross, and St. Joseph. Projects ranged from marketing sites and\n            concept work to internal development tools.\n          ");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n        ");
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("h5");
        var el7 = dom.createTextNode("Yottabyte");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n          ");
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("p");
        var el7 = dom.createTextNode("\n            Developed the UI for a cloud-based operating system, created an\n            icon suite, and handled all graphic design for the company.\n          ");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n        ");
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("h5");
        var el7 = dom.createTextNode("SongsForTeaching.com");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n          ");
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("p");
        var el7 = dom.createTextNode("\n            Illustrated hundereds of coloring pages, created web graphics, and\n            handled tech support for customer service.\n          ");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n        ");
        dom.appendChild(el5, el6);
